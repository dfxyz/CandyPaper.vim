...
let s:lightgreen   = "#9bde59" "String
...
call <SID>X("ModeMsg", s:lightgreen, "", "none")
call <SID>X("MoreMsg", s:lightgreen, "", "none")
call <SID>X("Question", s:lightgreen, "", "none")
...
call <SID>X("Character", s:lightgreen, "", "none")
...
call <SID>X("String", s:lightgreen, "", "none")
...
call <SID>X("makeSpecTarget", s:lightgreen, "", "none")
...
call <SID>X("perlSpecialString", s:lightgreen, "", "none")
...
call <SID>X("phpBackslashSequences", s:lightgreen, "", "none")
...
call <SID>X("pythonString", s:lightgreen, "", "none")
call <SID>X("pythonEscape", s:lightgreen, "", "none")
...
call <SID>X("rubyStringDelimiter", s:lightgreen, "", "none")
...
call <SID>X("shQuote", s:lightgreen, "", "none")
...
call <SID>X("mysqlVariable", s:lightgreen, "", "none")
...
call <SID>X("vimSynType", s:lightgreen, "", "none")
