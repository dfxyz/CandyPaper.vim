...
let s:greenyellow  = "#bdde59" "String
...
call <SID>X("ModeMsg", s:greenyellow, "", "none")
call <SID>X("MoreMsg", s:greenyellow, "", "none")
call <SID>X("Question", s:greenyellow, "", "none")
...
call <SID>X("Character", s:greenyellow, "", "none")
...
call <SID>X("String", s:greenyellow, "", "none")
...
call <SID>X("makeSpecTarget", s:greenyellow, "", "none")
...
call <SID>X("perlSpecialString", s:greenyellow, "", "none")
...
call <SID>X("phpBackslashSequences", s:greenyellow, "", "none")
...
call <SID>X("pythonString", s:greenyellow, "", "none")
call <SID>X("pythonEscape", s:greenyellow, "", "none")
...
call <SID>X("rubyStringDelimiter", s:greenyellow, "", "none")
...
call <SID>X("shQuote", s:greenyellow, "", "none")
...
call <SID>X("mysqlVariable", s:greenyellow, "", "none")
...
call <SID>X("vimSynType", s:greenyellow, "", "none")
